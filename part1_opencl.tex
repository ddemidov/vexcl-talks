...
\begin{frame}[fragile]{Boost.Compute --- почти полная реализация STL на OpenCL}
    \begin{itemize}
        \item Контейнеры
            \begin{itemize}
                \item \code{vector}, \code{string}, \code{flat_map},
                    \code{flat_set}, \code{array}, \ldots
            \end{itemize}
        \item Алгоритмы
            \begin{itemize}
                \item \code{fill}, \code{copy}, \code{transform},
    ...
    \begin{itemize}
        \item VexCL provides FFT implementation\footnote{Contributed by
            ...
            \begin{itemize}
                ...
                \item 2-3 times slower than Nvidia's CUFFT, about same speed as
                    AMD's clFFT
            \end{itemize}
    \end{itemize}
