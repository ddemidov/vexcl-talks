    ...
    \begin{columns}
        \begin{column}{0.55\textwidth}
            ...
            \begin{equation*}
                ...
                \approx 4 \frac{\text{\color{chameleon2}{points in circle}}}{\text{all points}}
            \end{equation*}
        \end{column}
            ...
            \begin{itemize}
                \item Each terminal should tell VexCL how to use it:
                    \begin{itemize}
                        ...
                        \item<alert@3> What kernel parameters does it need?
                        \item<alert@4> Does it need local preamble?
                        \item<alert@5> What contribution does it make to
                            expression string?
                        \item<alert@6> How to set kernel parameters?
                    \end{itemize}
            \end{itemize}
        \end{column}
    \end{columns}
