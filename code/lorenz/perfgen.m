...
chameleon1 = [140,  64,  20] / 255;
chameleon2 = [217, 171, 130] / 255;
chameleon3 = [191, 143,  84] / 255;
chameleon4 = [166, 105,  51] / 255;
...
ex = [ ...
    ...
    experiment('vexcl_naive',     'VexCL(naive)', 'v-', chameleon3, ms, lw) ...
    experiment('thrust',          'Thrust',       'o-', chameleon2, ms, lw) ...
    experiment('cpu',             'OpenMP',       '--', 'k',        ms, 0.5) ...
    experiment('vexcl_generated', 'VexCL(gen)',   'v-', chameleon4, ms, lw) ...
    ];
