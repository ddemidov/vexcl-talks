\documentclass[@BEAMER_OPTIONS@]{beamer}
    ...
    \hypersetup{colorlinks,linkcolor=,urlcolor=chameleon3}
    \usepackage{graphicx}
    ...
    \lstset{
        ...
        keywordstyle=\color{chameleon3}\bfseries,
        commentstyle=\color{chameleon3}\it\ttfamily,
    ...
    \input{ribbon}
    \newcommand{\forkme}{\ribbon{east}{chameleon1}{white}{\href{https://github.com/ddemidov/vexcl}{\color{white}Fork me on GitHub}}}
...
)
{
    ...
    \begin{tikzpicture}[overlay,scale=0.6]
        \draw (16,8) node(sub)[draw,fill=chameleon4,ellipse]{$-$};

        \draw (sub) +(-2.00,-1) node(mul)[draw,fill=chameleon4,ellipse]{$*$};
        \draw (sub) +( 2.00,-1) node(sin)[draw,fill=chameleon4,ellipse]{sin};
        \draw (mul) +(-2.00,-1) node(two)[draw,fill=chameleon4,minimum size=0.5cm]{2};
        \draw (mul) +( 2.00,-1) node(y)  [draw,fill=chameleon4,minimum size=0.5cm]{y};
        \draw (sin) +( 1.75,-1) node(z)  [draw,fill=chameleon4,minimum size=0.5cm]{z};
...
)
{
    ...
    \end{exampleblock}
    \begin{tikzpicture}[overlay,scale=0.6]
        \draw (16,8.75) node(sqrt)[draw,fill=chameleon4,ellipse]{sqrt};

        \draw (sqrt) +(0.00,-2) node(sqr)[draw,fill=chameleon4,ellipse]{sqr};

        \draw (sqr) +(-2.00,-1) node(x) [draw,fill=chameleon4,minimum size=0.5cm]{x};
        \draw (sqr) +( 2.20,-1) node(y) [draw,fill=chameleon4,minimum size=0.5cm]{y};
