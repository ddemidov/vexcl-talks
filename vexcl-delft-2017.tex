...
\begin{frame}[fragile]{Creating python bindings for \CXX with PyBind11}
    ...
    \begin{columns}
        \begin{column}[c]{0.25\textwidth}
            \begin{exampleblock}{}
                \begin{adjustbox}{width=0.27\textwidth, height=\textheight, keepaspectratio}
                    \begin{minipage}{\textwidth}
                        \begin{uncoverenv}<1>
                        ...
                        \end{uncoverenv}
                        \begin{uncoverenv}<1,5>
                            \lstinputlisting[numbers=none, linerange={53-70}]{code/pylorenz.cpp}
                        \end{uncoverenv}
                    \end{minipage}
                \end{adjustbox}
            \end{exampleblock}
        ...
        \begin{column}[c]{0.7\textwidth}
            ...
            \begin{onlyenv}<5>
                \begin{exampleblock}{4. Python bindings}
                    \begin{adjustbox}{width=0.6\textwidth, height=\textheight, keepaspectratio}
                        \begin{minipage}{\textwidth}
                            \lstinputlisting[firstnumber=54, linerange={54-70}]{code/pylorenz.cpp}
                        \end{minipage}
                    \end{adjustbox}
                \end{exampleblock}
            \end{onlyenv}
