\documentclass[@BEAMER_OPTIONS@]{beamer}
    ...
    \institute{Institute of System Research / Russian Academy of Sciences,\\
                ...
                \begin{adjustbox}{width=0.25\textwidth, height=\textheight, keepaspectratio}
                    \begin{minipage}{\textwidth}
                        ...
                        \begin{uncoverenv}<1,3>
                            \lstinputlisting[numbers=none,linerange={15-31}]{code/hello-opencl.cpp}
                        \end{uncoverenv}
                        \begin{uncoverenv}<1,4>
                            \lstinputlisting[numbers=none,linerange={32-33}]{code/hello-opencl.cpp}
                        \end{uncoverenv}
                        \begin{uncoverenv}<1,5>
                            \lstinputlisting[numbers=none,linerange={34-42}]{code/hello-opencl.cpp}
                        \end{uncoverenv}
                        \begin{uncoverenv}<1,6>
                            \lstinputlisting[numbers=none,linerange={43-49}]{code/hello-opencl.cpp}
                        \end{uncoverenv}
                        \begin{uncoverenv}<1,7>
                            \lstinputlisting[numbers=none,linerange={50-62}]{code/hello-opencl.cpp}
                        \end{uncoverenv}
        ...
        \begin{column}[c]{0.7\textwidth}
            ...
            \begin{onlyenv}<3>
                \begin{exampleblock}{2. Get the first available GPU}
                    \begin{adjustbox}{width=0.75\textwidth, height=\textheight, keepaspectratio}
                        \begin{minipage}{\textwidth}
                            \lstinputlisting[firstnumber=16, linerange={16-31}]{code/hello-opencl.cpp}
                        \end{minipage}
                    \end{adjustbox}
                \end{exampleblock}
            \end{onlyenv}
            \begin{onlyenv}<4>
                \begin{exampleblock}{3. Create command queue}
                    \begin{adjustbox}{width=0.75\textwidth, height=\textheight, keepaspectratio}
                        \begin{minipage}{\textwidth}
                            \lstinputlisting[firstnumber=33, linerange={33-33}]{code/hello-opencl.cpp}
                        \end{minipage}
                    \end{adjustbox}
                \end{exampleblock}
            \end{onlyenv}
            ...
            \begin{onlyenv}<6>
                \begin{exampleblock}{5. Write the compute kernel source}
                    \begin{adjustbox}{width=0.75\textwidth, height=\textheight, keepaspectratio}
                        \begin{minipage}{\textwidth}
                            \lstinputlisting[firstnumber=44, linerange={44-49}]{code/hello-opencl.cpp}
                        \end{minipage}
                    \end{adjustbox}
                \end{exampleblock}
            \end{onlyenv}
            ...
            \end{onlyenv}
            \begin{onlyenv}<8>
                \begin{exampleblock}{7. Set kernel arguments and launch the computation}
                    \begin{adjustbox}{width=0.75\textwidth, height=\textheight, keepaspectratio}
                        \begin{minipage}{\textwidth}
            ...
            \end{onlyenv}
            \begin{onlyenv}<9>
                \begin{exampleblock}{8. Get the results from the compute device}
                    \begin{adjustbox}{width=0.75\textwidth, height=\textheight, keepaspectratio}
                        \begin{minipage}{\textwidth}
        ...
        \begin{column}[c]{0.35\textwidth}
            \begin{exampleblock}{}
                \begin{adjustbox}{width=0.42\textwidth, height=\textheight, keepaspectratio}
                    \begin{minipage}{\textwidth}
                        \begin{uncoverenv}<1>
                            \lstinputlisting[numbers=none,linerange={1-7}]{code/lorenz-naive.cpp}
                        \end{uncoverenv}
                        \begin{uncoverenv}<1,2>
                            \lstinputlisting[numbers=none,linerange={8-9}]{code/lorenz-naive.cpp}
                        \end{uncoverenv}
                        \begin{uncoverenv}<1,3>
                            \lstinputlisting[numbers=none,linerange={10-20}]{code/lorenz-naive.cpp}
                        \end{uncoverenv}
                        \begin{uncoverenv}<1,4>
                            \lstinputlisting[numbers=none,linerange={21-25}]{code/lorenz-naive.cpp}
                        \end{uncoverenv}
                        \begin{uncoverenv}<1,5>
                            \lstinputlisting[numbers=none,linerange={26-44}]{code/lorenz-naive.cpp}
                        \end{uncoverenv}
                    \end{minipage}
                \end{adjustbox}
            \end{exampleblock}
        ...
        \begin{column}[c]{0.62\textwidth}
            \begin{onlyenv}<2>
                \begin{exampleblock}{1. State type}
                    \begin{adjustbox}{width=0.75\textwidth, height=\textheight, keepaspectratio}
                        \begin{minipage}{\textwidth}
                            \lstinputlisting[firstnumber=9, linerange={9-9}]{code/lorenz-naive.cpp}
                        \end{minipage}
                    \end{adjustbox}
                \end{exampleblock}
            \end{onlyenv}
            \begin{onlyenv}<3>
                \begin{exampleblock}{2. System function}
                    \begin{adjustbox}{width=0.75\textwidth, height=\textheight, keepaspectratio}
                        \begin{minipage}{\textwidth}
                            \lstinputlisting[firstnumber=10, linerange={10-20}]{code/lorenz-naive.cpp}
                        \end{minipage}
                    \end{adjustbox}
                \end{exampleblock}
            \end{onlyenv}
            \begin{onlyenv}<4>
                \begin{exampleblock}{3. Stepper (integration algorithm)}
                    \begin{adjustbox}{width=0.75\textwidth, height=\textheight, keepaspectratio}
                        \begin{minipage}{\textwidth}
                            \lstinputlisting[firstnumber=22, linerange={22-25}]{code/lorenz-naive.cpp}
                        \end{minipage}
                    \end{adjustbox}
                \end{exampleblock}
            \end{onlyenv}
            \begin{onlyenv}<5>
                \begin{exampleblock}{4. Integrate}
                    \begin{adjustbox}{width=0.75\textwidth, height=\textheight, keepaspectratio}
                        \begin{minipage}{\textwidth}
                            \lstinputlisting[firstnumber=27, linerange={27-44}]{code/lorenz-naive.cpp}
                        \end{minipage}
                    \end{adjustbox}
                \end{exampleblock}
            \end{onlyenv}
