        ...
        \begin{column}{0.45\textwidth}
            \begin{itemize}
                ...
                \item This would be 10x faster!
                    \begin{itemize}
                        \item<2|alert@2> \emph{At the expense of odeint's generality.}
                    \end{itemize}
            \end{itemize}
...
\begin{frame}[fragile]{VexCL symbolic types}
    \begin{itemize}
        ...
        \item An instance of the type dumps any arithmetic operations applied to output
            stream:
    \end{itemize}
    \begin{columns}
        \begin{column}{0.45\textwidth}
...
vex::symbolic<double> x = 2, y = 3;
vex::symbolic<double> z = sum(x, y);
                \end{lstlisting}
            \end{exampleblock}
        \end{column}
    \end{columns}
...
\begin{frame}[fragile]{Generate monolithic kernel using Boost.odeint algorithm}
    ...
    \item<2> Restrictions:
        \begin{itemize}
            ...
            \item Some precision may be lost when converting constants to
                strings.
        \end{itemize}
    \end{itemize}
    \footnoteline
...
\begin{frame}[fragile]{Performance of the generated kernel}
    \begin{figure}
        \includegraphics[width=0.9\textwidth]{cpu_vs_gpu_2}
    \end{figure}
\end{frame}
...
\begin{frame}{Comparing backends performance}
    \begin{figure}
        \includegraphics[width=0.9\textwidth]{backends}
    \end{figure}
\end{frame}
